...
*   **Что внутри:** Выполнены лабораторные работы, составлены отчеты по исследованию уязвимостей веб-приложений (OWASP Top 10) и тестам на проникновение (CTF🚩) в рамках профильного обучения (SkillFactory).
